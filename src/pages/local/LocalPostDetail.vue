<template>
  <div class="min-h-screen bg-gradient-to-b from-blue-50 to-white px-4 py-10">
    ...
    <div class="mx-auto max-w-4xl">
      ...
      <div
        v-if="post"
        class="mt-6 rounded-3xl border border-slate-100 bg-white p-8 shadow-sm"
      >
        ...
        <div class="flex items-start justify-between">
          ...
          <!-- 조회수 -->
          <div
            class="rounded-full bg-slate-50 px-4 py-2 text-sm text-slate-500"
          >
            조회 {{ post.views }}
          </div>
        ...
        <section>
          ...
          <div
            class="min-h-[220px] rounded-2xl bg-slate-50 p-6 text-sm leading-7 text-slate-700"
          >
            {{ post.content }}
          </div>
