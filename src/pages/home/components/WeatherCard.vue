   ...
   <article
          ...
          >
            <div class="flex items-start justify-between">
              <div>
                <span
                  class="inline-flex items-center rounded-full bg-cyan-400/10 px-2.5 py-0.5 text-xs font-semibold text-cyan-300 backdrop-blur-sm"
                >
                  LIVE BUSAN
                </span>
            ...
            <div class="mt-6 flex items-baseline gap-4">
              ...
              <div
                class="space-y-0.5 border-l border-cyan-500/30 pl-4 text-xs text-cyan-100/70"
              >
                <p>습도: 65%</p>
                <p>강수확률: 10%</p>
              </div>
